...
from mmlearn.modules.decoders.vocabulary import SentencePieceVocabulary
...
class Config:
  ...
  image_history_cfg: ImageResamplerConfig=field(default_factory=ImageResamplerConfig)
  audio_history_cfg: AudioResamplerConfig=field(default_factory=AudioResamplerConfig)
  ...
  image_vqgan: VQGANConfig=field(default_factory=VQGANConfig)
  audio_vqgan: AudioViTVQGANConfig=field(default_factory=AudioViTVQGANConfig)
  image_vit_cfg: ImageVitFeatureConfig=field(default_factory=ImageVitFeatureConfig)
  audio_vit_cfg: AudioVitFeatureConfig=field(default_factory=AudioVitFeatureConfig)
